...
Baileys and its maintainers cannot be held liable for misuse of this application, as stated in the [MIT license](https://github.com/KirBotzDev/Baileys/blob/master/LICENSE).
...
```
yarn add @kirbotzdev/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:KirBotzDev/Baileys
```

Then import your code using:
``` ts 
import makeWASocket from '@kirbotzdev/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@kirbotzdev/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@kirbotzdev/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@kirbotzdev/baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@kirbotzdev/baileys'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@kirbotzdev/baileys'
                                */
...
import { downloadMediaMessage } from '@kirbotzdev/baileys'
